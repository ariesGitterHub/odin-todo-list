...
function populateEditFolderForm(index) {
  ...
  console.log(extractedFolderValues.folderColor);
  
  editFolderColorPicked.style.backgroundColor = `var(${extractedFolderValues.folderColor})`;

  // editFolderColorPicked.style.color = `var(${extractedFolderValues.folderColor})`;
...
export function createEditFolderForm() {
  ...
  // editFolderTrashBtn.append(editFolderTrashBtnImg);
...
export function submitEditedFolder(index) {
...
// function checkForAsterix() {
//   // const invalidPattern = /\*/;
//   const editFolderName = document.querySelector("#edit-folder-name");
//   const editFolderTrashBtn = document.querySelector("#edit-trash-folder-btn");
//   const editFolderTrashBtnImg = document.querySelector(
//     "#edit-trash-folder-btn-img"
//   );
//   const editFolderColorPicked = document.querySelector("#edit-folder-color-picked")

//   if (editFolderName.value.includes("*")) {
//     console.log(editFolderName.value);
    
//     editFolderTrashBtn.remove();
//     editFolderTrashBtnImg.remove();
//     editFolderColorPicked.textContent = "Click on a color...";
//     editFolderColorPicked.style.width = "17ch";
//   }
// }
...
//   const folderTiles = document.querySelectorAll(".folder");
//   const folderTile = folderTiles[index];
//   if (editFolderTrashBtn) {
//     console.log(folderTile.dataset.id);
    
//     removeFolder(folderTile.dataset.id);
//   } else {
//     console.warn("editFolderTrashBtn is null or not found in the DOM.");
//   }
// }