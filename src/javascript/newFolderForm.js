...
headerContent.appendChild(newFolderForm);
    ...
    headerContent.appendChild(newFolderForm);
    newFolderForm.append(lvlCol1, lvlCol2, lvlRowWidth1);
    lvlCol1.append(newFolderImg, newFolderFormTitle);
